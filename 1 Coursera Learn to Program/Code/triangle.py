...
def area(base, height):
        ...
        Return the area of a trinagle with dimensions base and height.
...
def area_hero(side1, side2, side3):
        ''' (number, number, numbe) -> float

        Return the area of a triagle with sides of length side1, side2, and side3.
