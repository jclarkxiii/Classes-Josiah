...
def get_hours(seconds_since_midnight):
    ...
    seconds_since-midnight is a number of seconds since midnight. Return the
    number of hours that have elapsed since midnight, as seen on a 24-hour clock.
...
def get_minutes(seconds_since_midnight):
    ...
    seconds_since-midnight is a number of seconds since midnight. Return the
    number of minutes that have elapsed since midnight, as seen on a 24-hour clock.
...
def get_seconds(seconds_since_midnight):
    ...
    seconds_since-midnight is a number of seconds since midnight. Return the
    number of seconds that have elapsed since midnight, as seen on a 24-hour clock.
